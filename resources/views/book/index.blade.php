                            ...
                            <tr class="text-center">
                                ...
                                <td class="pt-5">
                                    <div class="btn-group">
                                        ...
                                        @cannot('update', $book)
                                            <button
                                                onclick="alert(`Sorry you are not the creator of this book, you don't have permission to update this.`)"
                                        ...
                                        @cannot('delete', $book)
                                            <button
                                                onclick="alert(`Sorry you are not the creator of this book, you don't have permission to delete this.`)"
                                                class="btn btn-sm btn-outline-dark">
                                                <i class="bi bi-trash3"></i>
                                            </button>
                                        @endcannot
